 ...
 *
 * Delas av kommandoradsskriptet och av den skyddade endpointen.
 */
...
/** Kör hela seedningen och lämnar tillbaka raderna som skrevs ut. */
export async function seedForeningen(payload: Payload): Promise<void> {
